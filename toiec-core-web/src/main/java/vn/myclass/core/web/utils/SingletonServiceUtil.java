...
public class SingletonServiceUtil {
    ...
    private  static TypeServiceImpl typeServiceImpl=null;


    public static TypeServiceImpl getTypeServiceInstance() {
        if (typeServiceImpl == null) {
            typeServiceImpl = new TypeServiceImpl();
        }
