                ...
                <form action="${editUserUrl}" method="POST" id="editUserForm">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="md-form">
                                    <input type="text" placeholder="<fmt:message key='label.user.fullname' bundle='${lang}'/>" class="form-control" value="${item.pojo.fullName}" id="fullname" name="pojo.fullName"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
