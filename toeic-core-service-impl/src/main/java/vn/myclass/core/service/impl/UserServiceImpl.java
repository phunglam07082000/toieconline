...
public class UserServiceImpl implements UserService {
    ...
    public UserDTO updateUser(UserDTO userDTO) {
        Timestamp creatdate=new Timestamp(System.currentTimeMillis());
        userDTO.setCreatedDate(creatdate);
        UserEntity entity = UserBeanUtils.dto2Entity(userDTO);
    ...
    public CheckLogin checkLogin(String name, String password) {
        ...
        if (name != null && password != null) {
            ...
            checkLogin.setUserExit((Boolean) objects[0]);
            if (checkLogin.isUserExit()) {
